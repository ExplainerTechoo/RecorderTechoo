...
const DEFAULT_ANNOUNCEMENT_FEED_URL =
	"https://raw.githubusercontent.com/ExplainerTechoo/RecorderTechoo/main/announcements.json";
...
function getAnnouncementFeedUrl(): string | null {
	const configuredUrl = process.env.RecorderTechoo_ANNOUNCEMENTS_URL?.trim();
