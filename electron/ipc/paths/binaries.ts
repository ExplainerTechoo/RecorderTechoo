...
export function getNativeCaptureHelperBinaryPath(): string {
	return path.join(app.getPath("userData"), "native-tools", "RecorderTechoo-screencapturekit-helper");
}
...
export function getSystemCursorHelperBinaryPath(): string {
	return path.join(app.getPath("userData"), "native-tools", "RecorderTechoo-system-cursors");
}
...
export function getNativeCursorMonitorBinaryPath(): string {
	return path.join(app.getPath("userData"), "native-tools", "RecorderTechoo-native-cursor-monitor");
}
...
export function getNativeWindowListBinaryPath(): string {
	return path.join(app.getPath("userData"), "native-tools", "RecorderTechoo-window-list");
}
...
export async function ensureNativeCaptureHelperBinary(): Promise<string> {
	...
	return ensureSwiftHelperBinary(
		...
		"RecorderTechoo-screencapturekit-helper",
	);
}
...
export async function ensureNativeCursorMonitorBinary(): Promise<string> {
	...
	return ensureSwiftHelperBinary(
		...
		"RecorderTechoo-native-cursor-monitor",
	);
}
