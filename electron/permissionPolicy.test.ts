...
const TRUSTED_DOCUMENT_BASE_URLS = [
	...
	"file:///C:/Program%20Files/RecorderTechoo/resources/app.asar/dist/index.html",
];
...
const FILE_HUD_URL =
	"file:///C:/Program%20Files/RecorderTechoo/resources/app.asar/dist/index.html?windowType=hud-overlay";
...
describe("isTrustedCaptureDocumentUrl", () => {
	...
	])("accepts a RecorderTechoo HUD document: %s", (candidateUrl) => {
	...
	it.each([
		...
		"file:///C:/Program%20Files/RecorderTechoo/resources/app.asar/dist/other.html?windowType=hud-overlay",
		"file:///C:/Program%20Files/RecorderTechoo/resources/app.asar/dist/index.html/child?windowType=hud-overlay",
		"data:text/html,RecorderTechoo?windowType=hud-overlay",
		"not a url",
	])("rejects a non-RecorderTechoo capture document: %s", (candidateUrl) => {
...
describe("shouldGrantDisplayCapture", () => {
	...
	it.each([
		["another BrowserWindow", { isTrustedCaptureWindow: false }],
		["a subframe", { isMainFrame: false }],
		["a non-RecorderTechoo document", { currentDocumentUrl: "https://example.com/" }],
