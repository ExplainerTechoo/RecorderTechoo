cask "RecorderTechoo" do
  ...
  url "https://github.com/ExplainerTechoo/RecorderTechoo/releases/download/v#{version}/RecorderTechoo-#{arch}.dmg"
  name "RecorderTechoo"
  desc "Creator-focused screen recorder with auto-zoom, cursor effects, and more"
  homepage "https://github.com/ExplainerTechoo/RecorderTechoo"
