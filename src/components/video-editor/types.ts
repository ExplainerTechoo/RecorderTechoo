...
export type ZoomTransitionEasing = "RecorderTechoo" | "glide" | "smooth" | "snappy" | "linear";
...
export const DEFAULT_ZOOM_IN_EASING: ZoomTransitionEasing = "RecorderTechoo";
export const DEFAULT_ZOOM_OUT_EASING: ZoomTransitionEasing = "RecorderTechoo";
